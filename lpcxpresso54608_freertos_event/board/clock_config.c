...
sources:
- {id: SYSCON._clk_in.outFreq, value: 10 Hz}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
- {id: USB0_clock.outFreq, value: 180 MHz}
settings:
- {id: SYSCON.AHBCLKDIV.scale, value: '1', locked: true}
...
- {id: SYSCON.USB0CLKDIV.scale, value: '1', locked: true}
- {id: SYSCON.USB0CLKSEL.sel, value: SYSCON.PLL_BYPASS}
- {id: SYSCON_PDRUNCFG0_PDEN_SYS_PLL_CFG, value: Power_up}
sources:
- {id: SYSCON._clk_in.outFreq, value: 10 MHz}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void BOARD_BootClockPLL180M(void)
{
    ...
    CLOCK_AttachClk(kSYS_PLL_to_USB0_CLK);                    /*!< Switch USB0_CLK to SYS_PLL */
...
name: ClocksFunc_1
outputs:
- {id: CLKOUT_clock.outFreq, value: 32.768 kHz}
- {id: FRO12M_clock.outFreq, value: 12 MHz}
- {id: FROHF_clock.outFreq, value: 48 MHz}
- {id: FXCOMs_CLK32K_clock.outFreq, value: 32.768 kHz}
- {id: MAIN_clock.outFreq, value: 32.768 kHz}
- {id: SYSPLL_clock.outFreq, value: 36 MHz}
- {id: System_clock.outFreq, value: 32.768 kHz}
settings:
- {id: SYSCON.AHBCLKDIV.scale, value: '1', locked: true}
- {id: SYSCON.MAINCLKSELA.sel, value: SYSCON._clk_in}
- {id: SYSCON.MAINCLKSELB.sel, value: RTC.rtc_osc_32k_clk}
...
- {id: SYSCON._clk_in.outFreq, value: 25 MHz}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
void ClocksFunc_1(void)
{
    ...
    /*!< Set up clock selectors - Attach clocks to the peripheries */
    CLOCK_AttachClk(kOSC32K_to_MAIN_CLK);               /*!< Switch MAIN_CLK to OSC32K_OSC */
